...
TEST_CASES = [
    ...
    # TestCase(DateTime, datetime(2020, 1, 2, 3, 4, 5), "2020-01-02T03:04:05"),
    ...
    # TestCase(LargeBinary, b"1234", "MTIzNA=="),
    # TestCase(Numeric, Decimal(1.2), "1.2000000000"),
    TestCase(SmallInteger, 1, "Int", 1),
    TestCase(String, "abc", "String", "abc"),
    TestCase(Text, "abcd", "String", "abcd"),
    # TestCase(Time, time(1, 2, 3, 4), "01:02:03.000004"),
    TestCase(Unicode, "ęžâ", "String", "ęžâ"),
    TestCase(UnicodeText, "žâü", "String", "žâü"),
    # TestCase(Uuid, UUID(int=1), "00000000-0000-0000-0000-000000000001")
    # sqlalchemy utils types
    # TestCase(UUIDType, UUID(int=1), "00000000-0000-0000-0000-000000000001"),
...
class TestSupportedColumnTypes:
    ...
    def test_type_conversion(
        self, test_case: TestCase, table_factory, executor
    ):
        ...
        assert print_type(schema.type_map["Dummy"]) == f"type Dummy {{\n  member: {test_case.gql_type}\n}}"
